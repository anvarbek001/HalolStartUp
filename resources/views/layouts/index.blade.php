        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header
                ...
                <div class="flex items-center gap-2 ml-auto">
                    ...
                    <!-- Avatar -->
                    <button
                        class="w-8 h-8 rounded-xl bg-gradient-to-br from-primary-400 to-accent text-white text-sm font-display font-700 flex items-center justify-center shadow-md">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</button>
                </div>
            </header>
            ...
            return {
                ...
                navItems: [{
                    ...
                    },
                    {
                        id: 'messages',
                        label: 'Xabarlar',
                        icon: `<svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>`
                    },
                ],
